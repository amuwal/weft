...
struct OnboardingView: View {
    ...
    var body: some View {
        ZStack {
            ...
            radialGlow
            content
                .animation(.weftSpring, value: step)
        }
    }
    ...
    private var welcome: some View {
        VStack(spacing: Spacing.huge) {
            ...
            Spacer()
            Button("Begin") { withAnimation(.weftSpring) { step = .rhythm } }
    ...
    private var rhythmPicker: some View {
        VStack(alignment: .leading, spacing: Spacing.l) {
            Button {
                ...
                withAnimation(.weftSpring) { step = .welcome }
            } label: {
            ...
            HStack(spacing: Spacing.m) {
                Button("Skip", action: complete)
                    .buttonStyle(WeftGhostButtonStyle())
    ...
    private func complete() {
        Haptic.success.play()
        withAnimation(.weftCalm) { onboardingComplete = true }
    }
}
...
struct WeftGhostButtonStyle: ButtonStyle {
    func makeBody(configuration: Configuration) -> some View {
        configuration.label
